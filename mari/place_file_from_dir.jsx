...
function create_new_udim_document()
{
    ...
    if (dir)
    {
        create_udim_tiles(doc=active_doc, create_artboard=true, add_graphics_layer=true)
    }
...
function add_to_udim_document()
{
    ...
    if (dir)
    {
        ...
        create_udim_tiles(doc=active_doc, create_artboard=false, add_graphics_layer=false)
    }   
}
function create_udim_tiles(doc, create_artboard, add_graphics_layer)
{
    ...
    for(var i = 0; i < num_img; i++)
    {
        ...
        var left = (inc%num_col)*tile_size;
        var top = Math.floor(inc/num_col)*tile_size;
        placed_img.left = start_x + left;
        placed_img.top = start_y + top;
        placed_img.width = placed_img.height = tile_size;
        /*
        for(x in placed_img)
        {
            $.writeln(x)
...
create_new_udim_document();
//add_to_udim_document();